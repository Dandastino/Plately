...
const ManageDishForm = () => {
    ...
    // i want to creare a checklist of all the dishes in the db
    // and then i want to be able to select one of them and edit it or delete it
    // when i select a dish i want to be able to see all the details of the dish
